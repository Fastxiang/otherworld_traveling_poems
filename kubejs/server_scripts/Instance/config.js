...
const dungeonMobs = {
    fast1: {
        ...
        2: [{ type: 'minecraft:zombie', count: 4, xp: 3 }, { type: 'minecraft:zombie', count: 6, xp: 3 }],
        3: [{ type: 'minecraft:zombie', count: 15, xp: 3 }]
    },
    fast2: {
        1: [{ type: 'grimoireofgaia:orc', count: 1, xp: 12 }],
        2: [{ type: 'grimoireofgaia:mimic', count: 1, xp: 12 }],
        3: [{ type: 'grimoireofgaia:naga', count: 1, xp: 12 }]
    },
    fast3: {
        1: [{ type: 'grimoireofgaia:werecat', count: 1, xp: 15 }],
        2: [{ type: 'grimoireofgaia:sludge_girl', count: 1, xp: 15 }],
        3: [{ type: 'grimoireofgaia:werecat', count: 1, xp: 5 }, { type: 'grimoireofgaia:sludge_girl', count: 1, xp: 15 }]
    },
    fast4: { 
        1: [{ type: 'grimoireofgaia:matango', count: 2, xp: 10 }],
        2: [{ type: 'grimoireofgaia:shaman', count: 1, xp: 20 }],
        3: [{ type: 'grimoireofgaia:shaman', count: 2, xp: 20 }]
    },
    fast5: { 
        1: [{ type: 'list', count: 1, xp: 21 }, { type: 'list', count: 1, xp: 21 }],
        2: [{ type: 'list', count: 1, xp: 21 }, { type: 'list', count: 1, xp: 21 }, { type: 'list', count: 1, xp: 21 }],
        3: [{ type: 'list', count: 1, xp: 21 }, { type: 'list', count: 1, xp: 21 }, { type: 'list', count: 1, xp: 21 }, { type: 'list', count: 1, xp: 21 }]
    },
    fast6: {
        1: [{ type: 'fast:alex', count: 1, xp: 400 }]
    },
    fast7: {
        1: [{ type: 'mokels_bossfight_saphyra:witchboss', count: 1, xp: 92 }]
    },
    fast8: {
        1: [{ type: 'fast:zombie_summoner', count: 1, xp: 230 }]
    },
    fast9: {
        1: [{ type: 'minecraft:blaze', count: 5, xp: 9 }],
        2: [{ type: 'minecraft:blaze', count: 5, xp: 10 }],
        3: [{ type: 'minecraft:blaze', count: 6, xp: 11 }]
    },
    fast10: {
        1: [{ type: 'mowziesmobs:umvuthi', count: 1, xp: 400 }]
    },
    fast11: {
        1: [{ type: 'mowziesmobs:ferrous_wroughtnaut', count: 1, xp: 400 }]
    },
    fast12: {
        1: [{ type: 'mowziesmobs:frostmaw', count: 1, xp: 400 }]
    },
    fast13: {
        1: [{ type: 'irons_spellbooks:dead_king', count: 1, xp: 400 }]
    },
    fast14: {
        1: [{ type: 'remnant_ossukage:ossukage', count: 1, xp: 400 }]
    },
    fast15: {
        1: [{ type: 'mutantmonsters:mutant_zombie', count: 1, xp: 400 }]
    },
    fast16: {
        1: [{ type: 'cataclysm:ignis', count: 1, xp: 3600 }]
    },
    fast17: {
        1: [{ type: 'mutantmonsters:mutant_skeleton', count: 1, xp: 400 }]
    },
    fast18: {
        1: [{ type: 'mutantmonsters:mutant_enderman', count: 1, xp: 400 }]
    },
    fast19: {
        1: [{ type: 'mutantmonsters:mutant_creeper', count: 1, xp: 400 }]
    },
    fast20: {
        1: [{ type: "list", count: 1, xp: 60 },
        { type: "list", count: 1, xp: 60 },
        { type: "list", count: 1, xp: 60 },
        { type: "list", count: 1, xp: 60 },
        { type: "list", count: 1, xp: 60 },
        ]
    ...
    fast21: {
        1: [{ type: 'fast:mysterious_figure', count: 1, xp: 5000 }]
    },
    fast22: {
        1: [{ type: 'cataclysm:ender_guardian', count: 1, xp: 3600 }]
    },
    fast23: {
        1: [{ type: 'cataclysm:netherite_monstrosity', count: 1, xp: 3600 }]
    },
    fast24: {
        1: [{ type: 'cataclysm:the_harbinger', count: 1, xp: 3600 }]
    },
    fast25: {
        1: [{ type: 'cataclysm:the_leviathan', count: 1, xp: 3600 }]
    },
    fast26: {
        1: [{ type: 'cataclysm:ancient_remnant', count: 1, xp: 3600 }]
    },
    fast27: {
        1: [{ type: 'cataclysm:maledictus', count: 1, xp: 3600 }]
    },
    fast28: { 
        1: [{ type: "list", count: 1, xp: 30 },
        { type: "list", count: 1, xp: 30 },
        { type: "list", count: 1, xp: 30 },
        { type: "list", count: 1, xp: 30 },
        { type: "list", count: 1, xp: 30 },
        ],
        2: [{ type: "list", count: 1, xp: 30 },
        { type: "list", count: 1, xp: 30 },
        { type: "list", count: 1, xp: 30 },
        { type: "list", count: 1, xp: 30 },
        { type: "list", count: 1, xp: 30 },
    ...
    fast30: {
        1: [{ type: "list", count: 1, xp: 200 },
        { type: "list", count: 1, xp: 200 },
        { type: "list", count: 1, xp: 200 },
        ]
    },
    fast31: {
    ...
    fast34: {
        1: [{ type: 'cataclysm:amethyst_crab', count: 1, xp: 2700 }]
    },
    fast35: {
        1: [{ type: 'list', count: 1, xp: 12 },{ type: 'list', count: 1, xp: 12 },{ type: 'list', count: 1, xp: 12 }]
    },
    fast36: {
        1: [{ type: 'touhou_little_maid:fairy', count: 5, xp: 8 }],
        2: [{ type: 'touhou_little_maid:fairy', count: 6, xp: 8 }],
        3: [{ type: 'touhou_little_maid:fairy', count: 10, xp: 8 }]
    },
    fast37: {
        1: [{ type: 'irons_spellbooks:citadel_keeper', count: 1, xp: 36 }]
    },
    fast38: {
        1: [{ type: 'list', count: 1, xp: 25 }]
    },
    fast39: {
        1: [{ type: 'fast:mysterious_black_cloaked_swordsman', count: 1, xp: 400 }]
    },
    fast40: {
        1: [{ type: 'cataclysm:scylla', count: 1, xp: 3600 }]
    },
    fast41: {
        1: [{ type: "list", count: 1, xp: 17 },
        { type: "list", count: 1, xp: 17 },
        { type: "list", count: 1, xp: 17 },
        ]
    },
    fast42: {
        1: [{ type: "list", count: 1, xp: 13 },
        { type: "list", count: 1, xp: 13 },
        ],
        2: [{ type: "list", count: 1, xp: 13 },
        { type: "list", count: 1, xp: 13 },
        { type: "list", count: 1, xp: 13 },
        ]
    },
...
const dungeonConfig = {
    ...
    fast16: {
        ...
        reward: [
            ...
            {
                item: 'fast:ancient_misc_soul_fiery',
                count: 1,
                chance: 0.3
            },
            {
                item: 'fast:ancient_misc_soul_fire',
                count: 1,
                chance: 0.3
            },
            {
    ...
    fast40: {
        ...
        reward: [
            ...
            {
                item: 'fast:ancient_lightning_bottle',
                count: 1,
                chance: 0.3
            },
            {
                item: 'fast:ancient_lightning_particle',
                count: 1,
                chance: 0.3
            },
            {
...
function registerDungeonRaw(name, data) {
  if (!data) return
  if (data.mobs) dungeonMobs[name] = data.mobs;
  if (data.list) dungeonLists[name] = data.list;
  if (data.config) dungeonConfig[name] = data.config;
}
	...
	server.scheduleInTicks(20, () => {
		server.scheduleInTicks(20, () => {
			server.scheduleInTicks(20, () => {
				...
				spawnWave(x, y, z, 1, selectedDungeon.type, block.level, PlayerUuid)
			})
...
// 修改后的生成波次函数
function spawnWave(x, y, z, waveNumber, dungeonType, level, PlayerUuid) {
    ...
    if (!player) {
    let thisaabb = createCenteredAABB(x, y, z, 55);
    level.getEntitiesWithin(thisaabb).forEach(entity => {
        if (entity.isPlayer()) {
        player = entity
        }
    });
	...
	waveConfig.forEach(mobConfig => {
		for (let i = 0; i < mobConfig.count; i++) {
			...
			if (mobType === "minecraft:skeleton") {
			mob.setItemSlot('mainhand', Item.of('minecraft:bow'));
			}
			
			if (mobConfig.attributes) {
             for (let attribute in mobConfig.attributes) {
             if (mobConfig.attributes.hasOwnProperty(attribute)) {
             let value = mobConfig.attributes[attribute];
             mob.setAttributeBaseValue(attribute, value);
             }
             }
            }
			
			if (mobConfig.equipment) {
            let equip = mobConfig.equipment;

            if (equip.mainhand) mob.setItemSlot('mainhand', equip.mainhand);
            if (equip.offhand) mob.setItemSlot('offhand', equip.offhand);

            if (equip.head) mob.setItemSlot('head', equip.head);
            if (equip.chest) mob.setItemSlot('chest', equip.chest);
            if (equip.legs) mob.setItemSlot('legs', equip.legs);
            if (equip.feet) mob.setItemSlot('feet', equip.feet);
            }
			...
			mob.persistentData.customData = { difflevelnum:diffLevelNum }
			
		    if (mobConfig.EnderBonus) {
            mob.persistentData.customData.enderbonus = mobConfig.EnderBonus
            }
...
EntityEvents.death(event => {
	...
	let PlayerUuid = Instance.playeruuid
	...
	if (killCount >= needkill) {
		if (waveNumber >= rewardConfig.totalWaves) {
			...
			// 生成下一波
			spawnWave(x, y, z, waveNumber, dungeonType, level, PlayerUuid)
		}
	}
})
