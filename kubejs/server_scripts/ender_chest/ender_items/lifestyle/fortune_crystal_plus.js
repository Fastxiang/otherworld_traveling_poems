...
registerItemMaidBauble("hmag:fortune_crystal_plus")
EnderBonusOnPlayerSdmShopSell.addBonus("hmag:fortune_crystal_plus", FortuneCrystalPlusEvent, 1)

registerItemMaidBauble("hmag:fortune_crystal")

function FortuneCrystalPlusEvent(handler, event) {
