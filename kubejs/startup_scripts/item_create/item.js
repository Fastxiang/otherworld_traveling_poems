...
for (let i = 1; i <= 50; i++) {
    ...
    event.create("fast:holy_garland", "basic")
        .unstackable();
    event.create("fast:holy_cup", "basic")
        .unstackable();
    event.create("fast:deceiver_mask", "basic")
        .unstackable();
    event.create("fast:ember_fragment", "basic")
        .unstackable();
    event.create("fast:fate_book", "basic")
        .unstackable();
    event.create("fast:gambler_zeal", "basic")
        .unstackable();
        
    event.create("fast:ancient_ignitium_ingot", "basic")
        .unstackable();
    event.create("fast:ancient_brass_ingot", "basic")
        .unstackable();
    event.create("fast:ancient_arcane_ingot", "basic")
        .unstackable();
        
    event.create("fast:magic_dragon_bone", "basic")
        .unstackable();
        
    event.create("fast:energy_core", "basic")
        .unstackable();
        
    event.create("fast:agi_dragon_bone", "basic")
        .unstackable();
    ...
    event.create("fast:reversal_book", "basic")
    
    event.create("fast:attribute_shard", "basic")
         .unstackable();
    ...
    event.create("fast:limit_break_staff", "basic")
         .unstackable();
         
    event.create("fast:resonance_pact", "basic")
         .unstackable();
    ...
    event.create("fast:deep_blue_core", "basic")
         .unstackable();
    ...
    event.create("fast:ancient_lightning_bottle", "basic")
         .unstackable();
         
    event.create("fast:ancient_misc_soul_fiery", "basic")
         .unstackable();
         
    event.create("fast:ancient_misc_soul_fire", "basic")
         .unstackable();
         
    event.create("fast:ancient_lightning_particle", "basic")
         .unstackable();
    ...
    event.create("fast:arcane_paranoia", "basic")
         .unstackable();
         
    event.create("fast:giant_fount", "basic")
         .unstackable();
    event.create("fast:breath_of_life", "basic")
         .unstackable();
    event.create("fast:sage_relic", "basic")
         .unstackable();
    event.create("fast:steel_verdict", "basic")
         .unstackable();
    event.create("fast:sunder_edict", "basic")
         .unstackable();
    ...
    event.create("fast:flask_of_venom", "basic")
        .unstackable()
