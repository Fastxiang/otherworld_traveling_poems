...
JEIAddedEvents.registerRecipes((event) => {
    event.custom("fast:ender_chest")
            ...
            .add({name: 'fast:str_gem', type: 'key', description: '副本掉落'})
            .add({name: 'fast:agi_gem', type: 'key', description: '副本掉落'})
            .add({name: 'fast:int_gem', type: 'key', description: '副本掉落'})
            .add({name: 'fast:vit_gem', type: 'key', description: '副本掉落'})
            ...
            .add({name: 'fast:reversal_book', type: 'key', description: '副本掉落或如何游玩任务赠送'})
            .add({name: 'fast:deep_blue_core', type: 'key', description: '通关深蓝之渊10层以及以上时结算获得'})
            .add({name: 'fast:ancient_lightning_particle', type: 'key', description: '副本掉落'})
            .add({name: 'fast:limit_break_staff', type: 'key', description: '副本掉落'})
            .add({name: 'fast:flask_of_venom', type: 'key', description: '副本掉落'})
            .add({name: 'fast:arcane_paranoia', type: 'key', description: '副本掉落'})
            .add({name: 'fast:ancient_lightning_bottle', type: 'key', description: '副本掉落'})
            .add({name: 'fast:ancient_misc_soul_fiery', type: 'key', description: '副本掉落'})
            .add({name: 'fast:ancient_misc_soul_fire', type: 'key', description: '副本掉落'})
            .add({name: 'fast:resonance_pact', type: 'key', description: '副本掉落'})
});
